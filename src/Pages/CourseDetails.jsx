    ...
    useEffect(()=>{
      ;(async()=>{
        try {
          ...
          console.log("Couldn't fetch Course Details")
        }
       ...
       <div className='mx-auto box-content px-4 lg:w-[1260px] 2xl:relative'>
        <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
          <div className='relative block max-h-[30rem] lg:hidden'>
            <div className='absolute bottom-0 left-0 h-full w-full shadow-[#161D29_0px_-64px_-28px_inset]'></div>
          ...
          <div className='flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 lg:hidden'>
            ...
            <button className='blackButton' onClick={()=> dispatch(addToCart(response?.data))}>Add to Cart</button>
          </div>
        </div>
        {/* Course Card */}
        ...
        <div className='max-w-[830px]'>
          ...
          <div className='mb-12 py-4'>
            ...
            <div className='flex items-center gap-4 py-4'>
              ...
              ? instructor.image
              :`https://api.dicebear.com/5.x/initials/svg?seed=${instructor.firstName} ${instructor.lastName}`} alt=""
