    ...
    className='fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm' >
        <div className='w-11/12 max-w-[350px] rounded-lg border border-richblack-400 bg-richblack-800 p-6'>
            ...
            <div className='flex items-center gap-x-4'>
                {/* error occuring in Iconbtn as it's not handling onclick */}
                ...
                className='bg-yellow-300 text-richblack-800 p-3 py-1 border border-richblack-400 border-rounded-md'>
